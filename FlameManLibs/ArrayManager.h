...
typedef struct AMPrintOptions {
	...
	char	*format;		/* format string for numbers; default is %g	*/
	char	*intFormat;		/* format string for ints; default is %d	*/
	char	*sep;			/* separator string; default is " " (space)	*/
	char	*title;			/* title string; default is NULL			*/
	char	*colLabel;		/* column label; default is NULL			*/
	char	*rowLabel;		/* row label; default is "Row #%d"			*/
	char	*planeLabel;	/* plane label; default is "Plane #%d"		*/
} AMPrintOptions;
