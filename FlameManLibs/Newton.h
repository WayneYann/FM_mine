...
typedef void ( *OutputFuncPtr )( void *, FILE *, char * ); 
...
public:
	...
	void				WriteOutput( void *object, FILE *fp, char* tail );
...
//	void				Update_timedepRHS( TTimePtr time );
    ...
    Flag                        forcefullstep;		// if TRUE, a fullstep Newton is done (GB)
...
//	void		InitDeltaTMax( TNewtonPtr bt ) { Delta_tMax = 100.0 * bt->GetDx(); };
	void		InitDeltaTMax( TNewtonPtr /*bt*/ ) { Delta_tMax = 1000.0; }; //10.0
